...
<template>
  <div class="admin-page">
    <section class="admin-hero"><div><p>证书角色控制</p><h1>运营控制台</h1><span>当前角色：<b>{{ roleLabel(role) }}</b>。按钮可见性只是交互提示，最终权限由 Fabric 证书属性和链码再次校验。</span></div><div class="network-state"><i></i><span>第二版网络</span><b>财务链码 · 活动链码</b></div></section>
